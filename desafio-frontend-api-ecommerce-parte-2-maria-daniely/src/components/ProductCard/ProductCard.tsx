...
const ProductCard: React.FC<PropsProductCard> = ({ urlImagem, nomeProduto, adicionarAoCarrinho }) => {
  return (
    <div className="bg-amber-50 rounded-lg p-4 text-center shadow-md flex flex-col items-center gap-3 w-52 min-h-[280px] box-border">
      ...
      <button
        className="bg-gray-800 text-rose-200 font-adlam rounded-2xl px-4 py-2 cursor-pointer flex items-center gap-2 text-sm font-bold transition-colors hover:bg-gray-300" 
        onClick={adicionarAoCarrinho}
      >
        <img src="/src/assets/carrinhoCompras.svg" alt="Adicionar ao carrinho" className="w-7 h-5 filter invert" />
